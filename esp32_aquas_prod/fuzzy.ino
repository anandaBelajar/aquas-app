/*
 * init the ph notfication FIS function
 */
...
/*
 * init the temp notfication FIS function
 */
void init_fuzzy_temp_notification(){
  //Start temp notification fuzzy input
  ...
  //Start temp notification fuzzy rule
...
/*
 * init the feed notfication FIS function
 */
void init_fuzzy_feed_notification(){
  //start feed notification fuzzy input
  ...
  //Start feed notification fuzzy output
  ...
  //Start feed notification fuzzy rule
...
/*
 * init the lighting FIS function
 */
void init_fuzzy_lighting(){
  //Start lighting notification fuzzy  lighting
  ...
  //Start lighting notification fuzzy output
  ...
  //Start lighting notification fuzzy rule
...
void do_notification_fuzzy() {
  ...
  //Start the nottification fuzzification
  fuzzy->setInput(1, global_ph_value);  
  fuzzy->setInput(2,  global_temp_value);
  fuzzy->setInput(3, global_ultrasonic_value);
  
  fuzzy->fuzzify();//do the fuzzification

  //Start the notification deffuzification
...
/*
 * do the lighting fuzzification and defuzzification function
 */
void do_lighting_fuzzy(){

  //Start lighitng fuzzification
  fuzzy->setInput(4, global_light_value);
  fuzzy->setInput(5, server_time);
  
  fuzzy->fuzzify(); //do the fuzzification

  //do the lighting defuzzification
  float lighting_fuzzy_output = fuzzy->defuzzify(4);


  //turn growlight on or off based of light condition and server time
